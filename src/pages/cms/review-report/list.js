...
import { activeFromDate, activeToDate, activeViewState, activeKeyword, activePageNum } from 'store/reducers/cms/ReviewReport';
...
const ReviewReportList = () => {
    ...
    const { reduceFromDate, reduceToDate, reduceKeyword, reduceViewState } = useSelector((state) => state.cmsReviewReport);
    ...
    const handleClick = (e) => {
        console.log(e);
        navigate(`/cms/review-report/reg/456456456`);
    ...
    return (
        <Grid container rowSpacing={4} columnSpacing={2.75} className="reviewReportList">
            <Grid item xs={12}>
                ...
                <TableHeader type="review-report" />
                <ContentLine>
                    <ScrollX>
