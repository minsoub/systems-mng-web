    ...
    return (
        <Grid container rowSpacing={4} columnSpacing={2.75} className={styles.notceView}>
            <Grid item xs={12}>
                ...
                <DetailContens type="economic-research" editMode={isEditMode} />
                <ShareSetting type="economic-research" editMode={isEditMode} />
                <PostSetting type="economic-research" editMode={isEditMode} />
                <BottomButtonSet type="economic-research" editMode={isEditMode} changeEditState={changeEditState} />
            </Grid>
        </Grid>
    );
};
