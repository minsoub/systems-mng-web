...
const ProfileUpdateForm = () => {
    ...
    const saveClick = () => {
        ...
        const emailPromise = doEncryptRSA(doDecrypt(authData.email));
        const currentPasswordPromise = doEncryptRSA(current_password);
        const newPasswordPromise = doEncryptRSA(new_password);
        const confirmPasswordPromise = doEncryptRSA(confirm_password);
                                ...
                                <TableBody>
                                    ...
                                    <TableRow>
                                        <TableCell component="th" scope="row" colSpan={3} style={{ height: 200, width: 680 }}>
                                            ...
                                            단, 허용되는 특수문자 (~!@#$%^&*_)외 다른 특수문자는 사용할 수 없습니다.<p></p>- 타 사이트와
