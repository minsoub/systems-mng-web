...
const cmsPressRelease = createSlice({
    name: 'cmsPressRelease',
    initialState,
    reducers: {
...
export default cmsPressRelease.reducer;

export const { activeFromDate, activeToDate, activeViewState, activeKeyword, activePageNum } = cmsPressRelease.actions;
