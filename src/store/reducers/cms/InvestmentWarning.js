...
const cmsInvestmentWarning = createSlice({
    name: 'cmsInvestmentWarning',
    initialState,
    reducers: {
...
export default cmsInvestmentWarning.reducer;

export const { activeFromDate, activeToDate, activeViewState, activeKeyword, activePageNum } = cmsInvestmentWarning.actions;
